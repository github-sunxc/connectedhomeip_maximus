                                                                       ...
                                                                       MutableByteSpan & outCertificateSigningRequest)
{
    ...
    // It is a flag to inform the Trusty OS use fixed p256_handle, and provide an opaque key
    ...
    // Append the fabric index behind of the magic number
...
CHIP_ERROR PersistentStorageOperationalKeystore::CommitOpKeypairForFabric(FabricIndex fabricIndex)
{
    ...
    VerifyOrReturnError(!memcmp(p256_handle, kTrustyMagicNumberFabricIndex, sizeof(kTrustyMagicNumberFabricIndex)), CHIP_ERROR_INTERNAL);
